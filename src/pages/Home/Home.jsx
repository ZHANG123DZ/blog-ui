...
const Home = () => {
  ...
  const getFeaturedPost = async () => {
    try {
      const postsFeatured = await postService.getFeaturedPost();
      return postsFeatured.data;
    } catch (error) {
      console.log(error);
      return [];
    }
  ...
  useEffect(() => {
    const loadTopic = async () => {
      setLoading(true);
      // Simulate API delay
      const postsFeatured = await getFeaturedPost();
      setFeaturedPost(postsFeatured);
      setLoading(false);
    };
    ...
    <div className={styles.home}>
      ...
      <div className="container">
        ...
        <section id="featured" className={styles.section}>
          ...
          <FeaturedPosts posts={featuredPost} maxPosts={3} showTitle={false} />
        </section>
